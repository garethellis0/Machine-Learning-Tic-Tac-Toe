...
/* package my-tic-tac-toe-0.1.0.0 */
#define VERSION_my_tic_tac_toe "0.1.0.0"
#define MIN_VERSION_my_tic_tac_toe(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "my-tic-tac-toe-0.1.0.0"

#define CURRENT_PACKAGE_KEY "my-tic-tac-toe-0.1.0.0"
